...
Copy the Lab 11 directory by starting from your home directory and typing:

  cp -r $master/lab/lab11 .

Part I:  Identifying Sort Algorithms (1 point)
----------------------------------------------
To help build your intuition of how these sorting algorithms work, take a look
at three algorithms in action.  Run Netscape and go to the Web page

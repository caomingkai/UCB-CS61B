...
public class DList1 {
    ...
    public void insertFront(int i) {
        ...
        if (size==0){
            ...
            DListNode1 nodeToBeInserted=new DListNode1(i);
            nodeToBeInserted.next=head;// handle new node and the node pointed by head( do this first)
            head.prev=nodeToBeInserted;// handle new node and the node pointed by head( do this first)
            head=nodeToBeInserted;// handle new node and the head node(do this later)
            size++;
        }
    }

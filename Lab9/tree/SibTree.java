...
//        TreeNode r, r1, r11,r12,r2, r21,r22,r3, r31, r32;
...
//      //------------------------------------
        ...
        try {
            ...
            r3 = r.child(3);
//      //------------------------------------
//            r1.insertChild(new Integer(11), 1);
//            r1.insertChild(new Integer(12), 2);
//            r2.insertChild(new Integer(21), 1);
//            r2.insertChild(new Integer(22), 2);
//      //------------------------------------
//                    //---------------------------------------------------------
...
//            //------------------------------------------
//            System.out.println("测试r的children:-----------"+((Integer) r.children()).intValue());
//            System.out.println("测试r2的item:-----------"+((Integer) r2.item()).intValue());
//            //            System.out.println(((Integer) r3.item()).intValue());
//            //------------------------------------------
            ...
            r32 = r3.child(2);
//            //------------------------------------------------------
//            System.out.println("测试r3的children:-----------"+((Integer) r3.children()).intValue());
//            System.out.println("测试r31的item:-----------"+((Integer) r31.item()).intValue());
//            //------------------------------------------------------

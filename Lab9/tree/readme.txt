...
Copy the Lab 9 directory by doing the following, starting from your home
directory.  Don't forget the "-r" switch in the cp command.

cp -r $master/lab/lab9 .

All the code is in the tree package.  You can compile it from your lab9

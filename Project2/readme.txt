...
of 4 or more are allowed.  You project partners do NOT have to be in your lab.
...
evaluation function and strategy in November.  During the tournament, we will
...
will receive gift certificates to Amoeba Music.

This is a difficult project.  Do not wait to start working on it.  If you don't
have the code that identifies legal moves implemented by October 27, you would
be well advised to wallow in neurotic spasms of fear and worry.  We will have
...
(October 17/18).  Your Lab 7 score depends on having a finished draft of your
...
your MachinePlayer takes substantially longer than 5 seconds to search
